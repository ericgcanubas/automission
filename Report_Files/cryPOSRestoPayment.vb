...
Public Class cryPOSRestoPayment
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Automission.cryPOSRestoPayment.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcryPOSRestoPayment
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cryPOSRestoPayment = New cryPOSRestoPayment()
        rpt.Site = Me.Site
        Return rpt
    End Function
