...
Public Class cryBalanceSheet
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Automission.cryBalanceSheet.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcryBalanceSheet
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cryBalanceSheet = New cryBalanceSheet()
        rpt.Site = Me.Site
        Return rpt
    End Function
