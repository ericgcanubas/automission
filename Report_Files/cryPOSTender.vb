...
Public Class cryPOSTender
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Automission.cryPOSTender.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_GET_TOTAL() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedcryPOSTender
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cryPOSTender = New cryPOSTender()
        rpt.Site = Me.Site
        Return rpt
    End Function
