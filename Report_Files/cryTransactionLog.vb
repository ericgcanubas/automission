...
Public Class cryTransactionLog
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Automission.cryTransactionLog.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcryTransactionLog
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cryTransactionLog = New cryTransactionLog()
        rpt.Site = Me.Site
        Return rpt
    End Function
