...
Public Class cryStockInOut
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Automission.cryStockInOut.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcryStockInOut
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cryStockInOut = New cryStockInOut()
        rpt.Site = Me.Site
        Return rpt
    End Function
