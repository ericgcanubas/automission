...
Public Class cryIncomeStatement
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Automission.cryIncomeStatement.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcryIncomeStatement
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cryIncomeStatement = New cryIncomeStatement()
        rpt.Site = Me.Site
        Return rpt
    End Function
