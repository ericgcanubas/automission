...
Module modFont
    ...
    Public Sub fLabel_Digital_L(ByVal Lbl As Label)
    ...
    Public Sub fLabel_Digital_LM(ByVal Lbl As Label)


        Lbl.Font = New Font(pfc.Families(0), 38, FontStyle.Bold)

    End Sub
    Public Sub fLabel_Digital_M(ByVal Lbl As Label)
    ...
    Public Sub fLabel_Digital_S(ByVal Lbl As Label)
