...
Module modExport
    ...
    Public Sub ExportingExcel(ByVal dgv As DataGridView, prFilename As String)
        Try
                ...
                For CurrentRowIndex As Integer = 0 To dgv.RowCount - 1 'current row index
                    ...
                    For CurrentColumnIndex As Integer = 0 To dgv.ColumnCount - 1 'current column index within row index
                        If dgv.Columns(CurrentColumnIndex).Visible = True Then
                            xlWorkSheet.Cells(2, ColNum + 1) = dgv.Columns(CurrentColumnIndex).HeaderText 'display header
                            xlWorkSheet.Cells(CurrentRowIndex + 3, ColNum + 1) = dgv(CurrentColumnIndex, CurrentRowIndex).Value.ToString()
                            ColNum += 1
                        End If
