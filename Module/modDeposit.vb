...
Module modDeposit
    ...
    Public Sub fAdd_Deposit_fund(ByVal prDgv As DataGridView, ByVal prNew As Boolean, ByVal prReceived_ID As String, ByVal prAccount_ID As String, ByVal prPayment_Method_ID As String, ByVal prCheck_No As String, ByVal prAmount As Double)
        Dim Received_name As String = fGetFieldValue("CONTACT", "ID", prReceived_ID, "NAME")
        Dim Account_name As String = fGetFieldValue("ACCOUNT", "ID", prAccount_ID, "NAME")
        Dim Payment_method_name As String = fGetFieldValue("PAYMENT_METHOD", "ID", prPayment_Method_ID, "DESCRIPTION")

        If prNew = True Then

            prDgv.Rows.Add("N", prReceived_ID, Received_name, prAccount_ID, Account_name, prPayment_Method_ID, Payment_method_name, prCheck_No, fNumFormatStandard(prAmount), 0, 0, "A")
